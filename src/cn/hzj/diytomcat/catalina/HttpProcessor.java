...
import cn.hzj.diytomcat.servlets.JspServlet;
import cn.hzj.diytomcat.util.Constant;
import cn.hzj.diytomcat.util.SessionManager;
...
import cn.hzj.diytomcat.servlets.DefaultServlet;
import cn.hzj.diytomcat.servlets.InvokerServlet;
...
public class HttpProcessor {
    public void execute(Socket s, cn.hzj.diytomcat.http.Request request, cn.hzj.diytomcat.http.Response response) {
        try {
    ...
    public void prepareSession(cn.hzj.diytomcat.http.Request request, cn.hzj.diytomcat.http.Response response) {
    ...
    private void handle200(Socket s, cn.hzj.diytomcat.http.Request request, cn.hzj.diytomcat.http.Response response)
            throws IOException {

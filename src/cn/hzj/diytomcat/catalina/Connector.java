...
import cn.hzj.diytomcat.util.ThreadPoolUtil;
...
public class Connector implements Runnable {
    int port;
    private cn.hzj.diytomcat.catalina.Service service;
    ...
    public Connector(cn.hzj.diytomcat.catalina.Service service) {
            ...
            while(true) {
                ...
                Runnable r = () -> {
                    try {
                        ...
                        cn.hzj.diytomcat.catalina.HttpProcessor processor = new HttpProcessor();

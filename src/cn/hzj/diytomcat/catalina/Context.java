...
import cn.hzj.diytomcat.http.ApplicationContext;
import cn.hzj.diytomcat.http.StandardServletConfig;
import cn.hzj.diytomcat.util.ContextXMLUtil;
import cn.hzj.diytomcat.watcher.ContextFileChangeWatcher;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.date.TimeInterval;
import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.log.LogFactory;
import cn.hzj.diytomcat.classloader.WebappClassLoader;
import cn.hzj.diytomcat.exception.WebConfigDuplicatedException;
...
public class Context {
    ...
    private cn.hzj.diytomcat.classloader.WebappClassLoader webappClassLoader;
    ...
    public Context(String path, String docBase, Host host, boolean reloadable) {
        ...
        this.webappClassLoader = new cn.hzj.diytomcat.classloader.WebappClassLoader(docBase, commonClassLoader);
    ...
    private void init() {
        ...
        try {
            checkDuplicated();
        } catch (cn.hzj.diytomcat.exception.WebConfigDuplicatedException e) {
    ...
    private void checkDuplicated(Document d, String mapping, String desc) throws cn.hzj.diytomcat.exception.WebConfigDuplicatedException {
        ...
        for (int i = 0; i < contents.size() - 1; i++) {
            ...
            if (contentPre.equals(contentNext)) {
                throw new cn.hzj.diytomcat.exception.WebConfigDuplicatedException(StrUtil.format(desc, contentPre));
            }
        }
    ...
    public cn.hzj.diytomcat.classloader.WebappClassLoader getWebappClassLoader() {

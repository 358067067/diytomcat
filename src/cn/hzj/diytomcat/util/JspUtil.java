...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/javaweb", "e:/IdeaProjects/javaweb/web", null,true);
            File file = new File("e:/IdeaProjects/javaweb/web/index.jsp");
    ...
    public static void compileJsp(Context context, File file) throws JasperException {
        ...
        String workPath = new File(cn.hzj.diytomcat.util.Constant.workFolder, subFolder).getAbsolutePath() + File.separator;
    ...
    public static String getServletPath(String uri, String subFolder) {
        ...
        File tempFile = FileUtil.file(cn.hzj.diytomcat.util.Constant.workFolder, subFolder, tempPath);
